...
**This module fundamental tools used to summarize the behavior of a variable, including the mean, median, pecentiles, box and whiskers plots (box plots), variance, and the standard deviation.**
