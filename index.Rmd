...
3.2    | [Summarizing data with the mean, variance, and standard deviation](module_03.2.html)
4.1    | [Distributions: The normal distribution and the central limit theorem](module_04.1.html)
4.2    | [Distributions: The t distribution](module_04.3.html)
...
6.1    | [Comparisons between two continuous variables: correlation](module_05.1.html)
6.2    | Comparisons between two continuous variables: linear models
