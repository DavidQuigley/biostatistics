...
5.1    | [Comparisons between two continuous variables: correlation](module_05.1.html)
5.2    | Comparisons between two continuous variables: linear models
6.1    | [Counts and categories: The Binomial, Chi-squared and Fisher's Exact tests](module_06.1.html)
6.2    | [Counts and categories: ANOVA](module_0.6.2.html)
