...
**This module defines a statistical variable. It introduces the fundamental tools used to visualize the distribution of a single variable, including scatter plots, bar plots, and histograms.**
